...
const AppLayout = ({ children }: { children?: React.ReactElement | React.ReactElement[]; }) => {
	...
	const { navbarPosition, setNavbarPosition, setIsMobile, setIsChannelsOpen, setIsMembersOpen, setIsHubsOpen, isChannelsOpen, isHubsOpen, isMobile } = useStoredSettingsStore();
	...
	return (
		<div className="h-screen grid overflow-x-hidden" style={{ gridTemplateColumns: gridTemplateColumns }}>
			<div className="h-full flex">
				<ResizablePanel noSize={isMobile} {...panelProps} className={cn(isHubsOpen && isMobile && "fixed z-[1] bg-background")}>
