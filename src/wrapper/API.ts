...
type MethodOptions<ForcedPayload = RequestData> =
	| string
	| {
			/**
...
class API {
	 ...
	 */
	async #makeRequest<Request = RequestData, ResponseOpt = ResponseData>(
		method: string,
		options: MethodOptions<Request>,
	): Promise<Response<ResponseOpt>> {
	 ...
	 * @returns The response object
	 */
	public async get<Request = RequestData, ResponseOpt = ResponseData>(
		options: MethodOptions<Request>,
	): Promise<Response<ResponseOpt>> {
	 ...
	 * @returns The response object
	 */
	public async del<Request = RequestData, ResponseOpt = ResponseData>(
		options: MethodOptions<Request>,
	): Promise<Response<ResponseOpt>> {
	 ...
	 * @returns The response object
	 */
	public async patch<Request = RequestData, ResponseOpt = ResponseData>(
		options: MethodOptions<Request>,
	): Promise<Response<ResponseOpt>> {
	 ...
	 * @returns The response object
	 */
	public async post<Request = RequestData, ResponseOpt = ResponseData>(
		options: MethodOptions<Request>,
	): Promise<Response<ResponseOpt>> {
	 ...
	 * @returns The response object
	 */
	public async put<Request = RequestData, ResponseOpt = ResponseData>(
		options: MethodOptions<Request>,
	): Promise<Response<ResponseOpt>> {
