...
} from "$/types/http/invites/createInvite.ts";
...
class Guild {
  ...
  public constructor(ws: Websocket, data: Partial<RawGuild>, partial = false) {
    // ? Partial guilds should be rare, they are from invites (or if the guild is unavailable)
    this.#ws = ws;
