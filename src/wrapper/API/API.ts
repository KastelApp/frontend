...
class API {
     ...
     */
    public async request<ResponseBody = Record<string, unknown>, RequestBody = Record<string, unknown>>(opts: APIOptions<RequestBody>): Promise<{
        status: number;
        ...
        try {
            ...
            const response = await fetch(completeUrl ? url : `${this.url}${noVersion ? "" : `/v${this.version}`}${url}`, {
                method,
                headers: {
                    ...finalHeaders,
                    ...headers
    ...
    public async get<ResponseBody = Record<string, unknown>>(url: string, opts?: { headers?: Record<string, string>, noVersion?: boolean, noAuth?: boolean }) {
    ...
    public async post<ResponseBody = Record<string, unknown>, RequestBody = Record<string, unknown>>(url: string, body?: RequestBody, opts?: { headers?: Record<string, string>, noVersion?: boolean, noAuth?: boolean }) {
    ...
    public async put<ResponseBody = Record<string, unknown>, RequestBody = Record<string, unknown>>(url: string, body?: RequestBody, opts?: { headers?: Record<string, string>, noVersion?: boolean, noAuth?: boolean }) {
        return this.request<ResponseBody, RequestBody>({
            url,
            method: "PUT",
            body,
    ...
    public async patch<ResponseBody = Record<string, unknown>, RequestBody = Record<string, unknown>>(url: string, body?: RequestBody, opts?: { headers?: Record<string, string>, noVersion?: boolean, noAuth?: boolean }) {
        return this.request<ResponseBody, RequestBody>({
            url,
            method: "PATCH",
            body,
    ...
    public async delete<ResponseBody = Record<string, unknown>, RequestBody = Record<string, unknown>>(url: string, body?: RequestBody, opts?: { headers?: Record<string, string>, noVersion?: boolean, noAuth?: boolean }) {
        return this.request<ResponseBody, RequestBody>({
            url,
            method: "DELETE",
            body,
