...
const permissionsDescriptions = {
	simple: {
		groups: {
			...
			ManageEmojis: {
				permissions: ["ManageEmojiName", "ManageEmojiImage", "CreateEmoji", "DeleteEmoji"],
				label: "Manage Emojis",
	...
	advanced: {
		groups: {
			...
			RoleName: {
				...
				description: "Allows the user to change the name of a role.",
			},
			RoleColor: {
				permissions: ["ManageRoleColor"],
				label: "Change Role Color",
				description: "Allows the user to change the color of a role.",
			},
			RolePosition: {
				permissions: ["ManageRolePosition"],
				label: "Change Role Position",
				description: "Allows the user to change the position of a role.",
			},
			RolePermissions: {
				permissions: ["ManageRolePermissions"],
				label: "Change Role Permissions",
				description: "Allows the user to change the permissions of a role.",
			},
			CreateRole: {
			...
			ChannelName: {
				...
				description: "Allows the user to change the name of a channel.",
			},
			ChannelPosition: {
				permissions: ["ManageChannelPosition"],
				label: "Change Channel Position",
				description: "Allows the user to change the position of a channel.",
			},
			ChannelTopic: {
				permissions: ["ManageChannelTopic"],
				label: "Change Channel Topic",
				description: "Allows the user to change the topic of a channel.",
			},
			ChannelSlowmode: {
				permissions: ["ManageChannelSlowmode"],
				label: "Change Channel Slowmode",
				description: "Allows the user to change the slowmode of a channel.",
			},
			ChannelAgeRestriction: {
				permissions: ["ManageChannelAgeRestriction"],
				label: "Change Channel Age Restriction",
				description: "Allows the user to change the age restriction of a channel.",
			},
			ChannelInvites: {
				permissions: ["ManageChannelInvites"],
				label: "Change Channel Invites",
				description: "Allows the user to change the invites of a channel.",
			},
			ChannelWebhooks: {
				permissions: ["ManageChannelWebhooks"],
				label: "Change Channel Webhooks",
				description: "Allows the user to change the webhooks of a channel.",
			},
			CreateChannel: {
				permissions: ["CreateChannel"],
				label: "Create Channel",
				description: "Allows the user to create channels.",
			},
			DeleteChannel: {
				permissions: ["DeleteChannel"],
				label: "Delete Channel",
				description: "Allows the user to delete channels.",
			},
			ManageChannelPermissionOverrides: {
				permissions: ["ManageChannelPermissionOverrides"],
				label: "Manage Channel Permission Overrides",
				description: "Allows the user to manage channel permission overrides.",
			},
			ViewChannels: {
				permissions: ["ViewChannels"],
				label: "View Channels",
				description: "Allows the user to view channels.",
			},
			ViewMessageHistory: {
				permissions: ["ViewMessageHistory"],
				label: "View Message History",
			...
			EmbedLinks: {
				permissions: ["EmbedLinks"],
				label: "Embed Links",
				description: "Allows the user to embed links.",
			},
			AttachFiles: {
				permissions: ["AttachFiles"],
				label: "Attach Files",
			...
			AddReactions: {
				permissions: ["AddReactions"],
				label: "Add Reactions",
				description: "Allows the user to add reactions.",
			},
			UseExternalEmojis: {
				permissions: ["UseExternalEmojis"],
				label: "Use External Emojis",
			...
			UseChatFormatting: {
				permissions: ["UseChatFormatting"],
				label: "Use Chat Formatting",
				description: "Allows the user to use chat formatting.",
			},
			ManageMessages: {
				permissions: ["ManageMessages"],
				label: "Manage Messages",
				description: "Allows the user to manage messages.",
			},
			BypassSlowmode: {
				permissions: ["BypassSlowmode"],
				label: "Bypass Slowmode",
				description: "Allows the user to bypass slowmode.",
			},
			MemberRoles: {
				permissions: ["ManageMemberRoles"],
				label: "Change Member Roles",
				description: "Allows the user to change the roles of a member.",
			},
			MemberMute: {
				permissions: ["TimeoutMembers"],
				label: "Mute Member",
				description: "Allows the user to mute a member.",
			},
			MemberDeafen: {
				permissions: ["MemberDeafen"],
				label: "Deafen Member",
				description: "Allows the user to deafen a member.",
			},
			MemberMove: {
				permissions: ["MemberMove"],
				label: "Move Member",
				description: "Allows the user to move a member.",
			},
			MemberVoice: {
				permissions: ["MemberVoice"],
				label: "Change Member Voice",
				description: "Allows the user to change the voice of a member.",
			},
			EmojiName: {
				permissions: ["ManageEmojiName"],
				label: "Change Emoji Name",
				description: "Allows the user to change the name of an emoji.",
			},
			EmojiImage: {
				permissions: ["ManageEmojiImage"],
				label: "Change Emoji Image",
				description: "Allows the user to change the image of an emoji.",
			},
			UploadEmoji: {
				permissions: ["CreateEmoji"],
				label: "Upload Emoji",
				description: "Allows the user to upload emojis.",
			},
			DeleteEmoji: {
				permissions: ["DeleteEmoji"],
				label: "Delete Emoji",
				description: "Allows the user to delete emojis.",
			},
			BanMembers: {
				permissions: ["BanMembers"],
				label: "Ban Members",
				description: "Allows the user to ban members.",
			},
			UnbanMembers: {
				permissions: ["UnbanMembers"],
				label: "Unban Members",
				description: "Allows the user to unban members.",
			},
			ViewBans: {
				permissions: ["ViewBans"],
				label: "View Bans",
				description: "Allows the user to view bans.",
			},
			KickMembers: {
				permissions: ["KickMembers"],
				label: "Kick Members",
				description: "Allows the user to kick members.",
			},
			TimeoutMembers: {
				permissions: ["TimeoutMembers"],
				label: "Timeout Members",
				description: "Allows the user to timeout members.",
			},
			Nickname: {
			...
			ChangeNickname: {
				...
				description: "Allows the user to change other members' nicknames.",
			},
			CreateInvite: {
				permissions: ["CreateInvite"],
				label: "Create Invite",
				description: "Allows the user to create invites.",
			},
			DeleteInvite: {
				permissions: ["DeleteInvite"],
				label: "Delete Invite",
				description: "Allows the user to delete invites.",
			},
			ViewInvites: {
				permissions: ["ViewInvites"],
				label: "View Invites",
				description: "Allows the user to view invites.",
			},
		},
	},
} satisfies {
