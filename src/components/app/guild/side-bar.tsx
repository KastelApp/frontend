                ...
                ? sortedChannelGroups.map((channel) => {
                  ...
                  return (
                    ...
                    >
                      <div>
                        <Flex>
                          {client.currentChannel?.type === constants.channelTypes.GuildText && (
                            <svg
                              width="20px"
                              height="20px"
                          ...
                          {client.currentChannel?.isVoiceBased() && (
                          ...
                          {client.currentChannel?.type === constants.channelTypes.GuildNews && (
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              width="18px"
                              height="18px"
