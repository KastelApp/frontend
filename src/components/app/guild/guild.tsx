...
const Guild = ({
  ...
  useEffect(() => {
    ...
    const currentMember = members.find(
      (m) => m.userId === clientUser.id && m.guildId === guild.id,
    )!;
    ...
    const permissionHandler = new PermissionHandler(
      ...
      memberRoles,
      channels.filter((channel) => channel.guildId === guild.id),
    );
    const channelsWeHaveReadAccessTo = channels.filter(
      (channel) =>
