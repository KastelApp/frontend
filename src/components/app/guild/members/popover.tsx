...
const UserPopOver = ({
  ...
  const roles = useRoleStore((s) =>
    s.roles.filter((role) => member?.roleIds.includes(role.id)),
  );
        ...
        >
            ...
            >
              <Text
                ...
                onClick={(e) => {
                  ...
                  if (!isOpen && messageCount < messages.length - 1)
          ...
          {user.activities.length > 0 && (
            <>
              ...
              <Flex mt={2} ml={2} direction={"column"}>
                {" "}
          ...
          {member && (
            <>
              ...
              <Flex mt={2} ml={2} direction={"row"} wrap={"wrap"}>
                    ...
                    <Flex key={index} alignItems={"center"} mt={1} mr={2}>
                      ...
                      >
                        <Box
                          ...
                          ml={1}
                        />
                        <Text ml={1} mr={1} fontSize={"xs"} color={"gray.300"}>
                          {role.name}
                        </Text>
                      </Box>
                    </Flex>
