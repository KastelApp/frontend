...
import { useCantConnectStore } from "@/utils/stores.ts";
...
const Loading = () => {
  ...
  const cantConnect = useCantConnectStore((state) => state.cantConnect);
  ...
  return (
    <>
      <Flex
        css={{
          backgroundImage: useColorModeValue(confettiLight, confettiDark),
