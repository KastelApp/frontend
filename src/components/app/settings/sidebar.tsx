...
const Settings_Sidebar: FC<SettingsSidebarProps> = ({
    selectedPage,
    setSelectedPage,
    children,
}) =>
...
const SidebarContent: FC<SettingsSidebarProps> = ({
                            selectedPage,
                            setSelectedPage,
                            onClose,
                            ...rest
...
const NavItem: FC<{
    children: (string | false | Element)[];
    key: string;
    selectedPage: any;
    id: number;
    onClick: () => any;
    icon: ElementType | undefined;
}> = ({selectedPage, id, icon, children, ...rest}) => {
    return (
        <Box
            as="a"
...
const MobileNav: FC<{ onOpen: () => void }> = ({onOpen, ...rest}) => {
    return (
        <Flex
            ml={{base: 0, md: 60}}
            px={{base: 4, md: 24}}
...
export {SettingsSidebar, SidebarContent, NavItem, MobileNav};