...
const getEmojiByUnicode = (
  unicode: string,
): {
  emoji: (typeof emojiData)[keyof typeof emojiData];
  unicode: string;
} | null => {
...
const getEmojisThatMatchKeyword = (
  keyword: string,
  matchCount = 1,
  limit = 100,
) => {
...
export { getEmojiByUnicode, getEmojisThatMatchKeyword, emojis };
