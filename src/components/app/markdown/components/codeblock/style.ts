// ? This is from react-syntax-highlighter, so respect its license??
...
const coldarkDarkWithoutFont = {
  ...
  'pre[class*="language-"] :where': {
    fontFamily: "unset",
  },
};

export default coldarkDark;

export { coldarkDarkWithoutFont };
