...
import { channelMention } from "./components/mentions/channelMention.tsx";
import { userMention } from "./components/mentions/userMention.tsx";
import { roleMention } from "./components/mentions/roleMention.tsx";
...
export const customRules = {
    ...
    defaultEmoji: {
        ...
        react: ({ content }: { content: string; }, _: unknown, state: { key: string; }) => (
