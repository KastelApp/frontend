...
const SaveChanges = ({
    ...
    return (
        <div className="pb-20 select-none">
            {isShowing && (
                <div className="bg-darkAccent border-2 border-gray-700 w-[85%] sm:w-[75%] h-14 rounded-lg absolute bottom-8 !z-[120] flex items-center justify-center left-[8%] sm:left-[22%]">
