        ...
        <div className="w-60 bg-darkAccent flex flex-col h-full">
            ...
            <div className="relative">
                {hasBanner && (
                    <Image
                        ...
                        alt="Server Banner"
                        className="mm-h-36 w-screen object-cover z-0"
                    />
                )}
                <Dropdown onOpenChange={setIsOpen} className="bg-darkAccent">
                    <DropdownTrigger>
                        <div className={cn("p-3 cursor-pointer", hasBanner && "absolute bottom-0 left-0 right-0 bg-gradient-to-t from-background to-transparent")}>

                            <div className="flex items-center">
                                <span className="text-white font-semibold">{foundHub.name || "Unknown Hub"}</span>
            ...
            <div className="p-2">
                <div className="flex justify-between mb-2">
                    {/* cool  */}
                    <Tooltip content="Modmail Coming Soon!" placement="bottom" className="bg-gradient-to-r from-branding-500 to-primary">
                    ...
                    <Tooltip content="Store Coming Soon!" placement="bottom" className="bg-gradient-to-r from-branding-500 to-primary">
                        <Button variant="ghost" size="icon" className="bg-charcoal-600" disabled>
            ...
            <Divider className="bg-[#1e1f22] h-[2px]" />
                    ...
                    <Draggables
                        ...
                        onDrop={(newItems, prevItems, droppedItem) => {
                            ...
                            for (const item of updatedItems) {
                                ...
                                if (apiReadyItems.some((found) => typeof found === "string" ? found === item.id : found.children.includes(item.id))) {
                                    continue;
                                }
                            ...
                            console.log(apiReadyItems.map((item) => (typeof item === "string" ? updatedItems.find((c) => c.id === item) : { channel: updatedItems.find((c) => c.id === item.id), children: item.children.map((c) => updatedItems.find((cc) => cc.id === c)) })));
                        }}
                        onDrag={(item, items) => {
