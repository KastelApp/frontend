...
const PendingFriends = () => {
    ...
    const renderCell = useCallback((user: User, columnKey: Key) => {
        ...
        switch (columnKey) {
            ...
            case "type": {
                return <Chip color={typeTypes[cellValue]} variant="flat">{cellValue}</Chip>;
            }
            case "actions": {
                return (
                    <Dropdown>
        ...
        return (
            <div className="flex flex-col gap-4">
                <div className="flex justify-between gap-3 items-end">
                    <div className="flex w-full sm:max-w-[44%] text-default-400 text-small ml-3">{users.length} Total pending friend requests</div>
