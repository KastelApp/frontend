            ...
            <DmNavBar title={
                ...
                topNavBarEndContent={
                    <div className="flex gap-1">
                        <Button color="primary" variant="flat" radius="none" className=" max-w-full h-6 max-h-6 text-xs rounded-sm">Send friend request</Button>
                        <Button color="danger" variant="flat" radius="none" className=" max-w-full h-6 max-h-6 text-xs rounded-sm">Block</Button>
                    </div>
                }
            >
                <TextBasedChannel />
